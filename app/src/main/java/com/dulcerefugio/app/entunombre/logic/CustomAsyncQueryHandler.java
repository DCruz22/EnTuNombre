...
public abstract class CustomAsyncQueryHandler extends Handler{
     ...
     *
     * @param token
     *            A token passed into {@link #onQueryComplete} to identify the
     *            query.
     * @param cookie
     ...
     *
     * @param token
     *            A token passed into {@link #onInsertComplete} to identify the
     *            insert operation.
     * @param cookie
     ...
     *
     * @param token
     *            A token passed into {@link #onUpdateComplete} to identify the
     *            update operation.
     * @param cookie
     ...
     *            {@link #startInsert}.
     * @param cookie
     *            the cookie object that's passed in from {@link #startInsert}.
     * @param uri
     ...
     *            {@link #startUpdate}.
     * @param cookie
     *            the cookie object that's passed in from {@link #startUpdate}.
     * @param result
     ...
     *            {@link #startDelete}.
     * @param cookie
     *            the cookie object that's passed in from {@link #startDelete}.
     * @param result
